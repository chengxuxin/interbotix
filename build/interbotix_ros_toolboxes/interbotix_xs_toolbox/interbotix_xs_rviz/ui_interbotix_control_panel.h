...
public:
    ...
    void setupUi(QWidget *InterbotixControlPanelUI)
    {
        ...
        pushbutton_robot_namespace_->setObjectName(QStringLiteral("pushbutton_robot_namespace_"));
...
""));
    ...
    void retranslateUi(QWidget *InterbotixControlPanelUI)
    {
        ...
        pushbutton_robot_namespace_->setText(QApplication::translate("InterbotixControlPanelUI", "Update", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
